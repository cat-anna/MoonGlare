...
class EntityManager final : private boost::noncopyable {
  public:
    template <class T>
    using Array = std::array<T, Component::Configuration::EntityLimit>;
  ...
  private:
    ...
    Memory::GenerationBuffer<Entity::Generation_t, Configuration::EntityLimit>
        generationbuffer;
    Memory::StaticIndexQueue<Entity::Index_t, Configuration::EntityLimit>
        allocator;
