...
struct IssueReportDockInfo : public QtShared::BaseDockWindowModule {
...
IssueReport::IssueReport(QWidget *parent, SharedModuleManager modmgr)
    ...
    auto issuereporteer = moduleManager->QueryModule<QtShared::IssueReporter>();
...
IssueReport::~IssueReport() { m_Ui.reset(); }
