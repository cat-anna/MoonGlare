...
struct XMLProcessor : public QtShared::iFileProcessor {

    XMLProcessor(SharedModuleManager modmgr, QtShared::SharedSetEnum xmlEnum, std::string URI)
        : QtShared::iFileProcessor(std::move(URI)), xmlEnum(xmlEnum), moduleManager(modmgr) {}
...
struct XMLProcessorModule : public iModule,
    ...
    std::vector<std::shared_ptr<QtShared::iCustomEnum>> GetCustomEnums() const override { return {/* xmlEnum, */}; }
