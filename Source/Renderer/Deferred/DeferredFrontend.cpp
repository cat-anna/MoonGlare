...
void DefferedFrontend::Mesh(const emath::fmat4 &ModelMatrix, const emath::fvec3 &basepos, Renderer::MeshResourceHandle meshH) {
    sink->Mesh(ModelMatrix, basepos, meshH);
}
