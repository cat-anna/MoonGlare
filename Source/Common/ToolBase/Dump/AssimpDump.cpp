...
template<>
static const std::map<aiPrimitiveType, const char*> & getFields<aiPrimitiveType>() {
...
template<>
static const std::map<aiLightSourceType, const char*> & getFields<aiLightSourceType>() {
...
template<>
static const std::map<aiMetadataType, const char*> & getFields<aiMetadataType>() {
...
template<>
static const std::map<aiTextureMapping, const char*> & getFields<aiTextureMapping>() {
...
template<>
static const std::map<aiTextureMapMode, const char*> & getFields<aiTextureMapMode>() {
...
template<typename T>
static std::string tobitfield(unsigned t) {
    std::stringstream ss;
    ss << tohex(t) << " [";
...
template<typename T>
static std::string convertEnum(T t) {
    std::stringstream ss;
    ss << tohex(t) << " [";
...
static void DumpStructure(DumpCfg & cfg, const aiScene *scene, std::ostream &out) {
...
static void DumpMaterialProps(DumpCfg & cfg, std::ostream & out, aiMaterial * mat) {
...
static void DumpMaterials(DumpCfg & cfg, const aiScene *scene, std::ostream &out) {
...
static void DumpTextures(DumpCfg & cfg, const aiScene *scene, std::ostream &out) {
...
static void DumpAnimations(DumpCfg & cfg, const aiScene *scene, std::ostream &out) {
