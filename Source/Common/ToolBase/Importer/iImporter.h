...
public:
    ...
    iImporter(SharedModuleManager smm, ImporterCreateData createData) : moduleManager(std::move(smm)), createData(std::move(createData)){}
...
public:
    virtual std::shared_ptr< iImporter> CreateImporter(SharedModuleManager smm, iImporter::ImporterCreateData createData = {}) = 0;
};
