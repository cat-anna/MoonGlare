...
struct UserQuestions {
    ...
    void ErrorMessage(const char *message) { QMessageBox::critical(GetParentWidget(), GetTitle(), message); }
    void ReportNotImplemented() { QMessageBox::information(GetParentWidget(), GetTitle(), "Not implemented"); }
