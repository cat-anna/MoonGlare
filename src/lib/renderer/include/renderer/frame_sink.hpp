...
public:
    ~FrameSink() override = default;
    FrameSink(gsl::not_null<iResourceManager *> res_manager) : resource_manager(res_manager) {}
...
private:
    ...
    FrameBuffer *current_frame_buffer{nullptr}; // TODO: atomic?
};
