...
struct alignas(16) VirtualCamera {
    ...
    const math::fmat4 &GetProjectionMatrix() const { return projection_matrix; }

    void CalculateModelMatrix(const math::fmat4 &mode_matrix, math::fmat4 &output) {
        output = projection_matrix * mode_matrix;
    }
