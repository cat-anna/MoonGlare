...
struct SoundBuffer {
    ...
    void SetData(ALuint buffer, ALenum format, const ALvoid *data, ALsizei size, ALsizei freq) const {
    ...
    ALfloat GetDuration() { return (ALfloat)GetDataSize() / (ALfloat)(GetBytesPerSecond()); }
